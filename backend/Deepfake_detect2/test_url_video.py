...
def detect_deepfake_video(video_urls, device):
    net_model = 'Xception'
    train_db = 'DFDC'
    face_policy = 'scale'
    face_size = 224
...
if __name__ == '__main__':
    ...
    video_urls = ['./notebook/samples/mqzvfufzoq.mp4']
    final_score = detect_deepfake_video(video_urls=video_urls, device=device)
    print(final_score)
